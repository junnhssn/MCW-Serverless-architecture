...
1. Open your serverless-architecture-DID resource group in the Azure portal, then select your Logic App.

![](media/logicapp-7.png)
...
1. Open your **ServerlessArchitecture-DID** resource group in the Azure portal, then select your **Storage account** you had provisioned to store uploaded photos and exported CSV files.
...
3. Select the **export** container.
    ...
    ![Export is selected under Name.](media/Storage-8.png 'Export option')
