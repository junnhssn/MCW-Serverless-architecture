...
3. On the **Create storage account** blade, specify the following configuration options:
    ...
    -  **Name**: Enter a unique value for the storage account name, such as **tollboothstorageDID** where DID is the **DeploymentID** which can be found from the **Environment Details** page.
